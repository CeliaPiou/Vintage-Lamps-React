        ...
        <section id="hero-section">
            ...
            <nav id="primary-nav"
                ...
                <ul className='flex'>
                    ...
                    {!auth ?
                        <Link to={{ pathname: `/connexion` }}>
                            <li className='drop-drown'>
                                <span className='invisible-thing'>Mon compte</span>
                    ...
                    <>
                        <li className='drop-drown'>
                            ...
                            <div className='dropdown-child'>
                                <p style={{ color : "#262626"}}>Bonjour, {auth.others?.username}</p>
                    ...
                    <Link to={{ pathname: `/cart`}}>
                        ...
                        id='cart'>
                            <span className='invisible-thing'>Panier</span>
            ...
            <div id="hero-section-text" className='flex'>
                ...
                <Link to={{ pathname: `/products`}}>
                    ...
                    Discover our lamps
                        <img src={gradient} alt="" width={500} className='btn-effect'></img>
                    </button>
                </Link>
            </div>
